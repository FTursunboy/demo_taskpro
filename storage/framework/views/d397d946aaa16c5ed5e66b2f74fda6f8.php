    ...
    <div class="offcanvas-body">
        <div class="card">
            <div class="card-body overflow-hidden">
                <div>
                    <table id="tasksInProgressTable" class="table table-hover mt-3 " cellpadding="5">
                        <thead>
                        <tr>
...
<script>
    $(document).ready(function () {
        var table = $('#tasksInProgressTable').DataTable({
            "processing": true,
            "stateSave": true
        });
        ...
        $("#tasksInProgressTable thead th").each(function(i) {
            ...
            if (filterColumns.includes(th.text().trim())) {
                var select = $('<select></select>')
                    ...
                    .on('change', function () {
                        ...
                        var filters = [];
                        $("#tasksInProgressTable thead select").each(function () {
                            var filter = {
...
<?php /**PATH /home/c/cx34222/task_manager/public_html/tasks/resources/views/user/pages/tasksInProgress.blade.php ENDPATH**/ ?>