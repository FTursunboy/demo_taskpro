<div class="offcanvas offcanvas-bottom" data-bs-backdrop="static" tabindex="-1" id="newTasks"
     aria-labelledby="newTasks" style="width: 100%; height: 100%;">
    <div class="offcanvas-header">
        <h5 class="offcanvas-title" id="ProjectOfCanvas">Новые задачи</h5>
    ...
    <div class="offcanvas-body">
        <div class="card">
            <div class="card-body overflow-hidden">
                <div>
                    <table id="newTasksTable" class="table table-hover mt-3 " cellpadding="5">
                        <thead>
                        <tr>
                        ...
                        <tbody>
                        <?php $__currentLoopData = $newTasks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $task): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
...
<script>
    $(document).ready(function () {
        var table = $('#newTasksTable').DataTable({
            "processing": true,
            "stateSave": true
        });
        ...
        $("#newTasksTable thead th").each(function(i) {
            ...
            if (filterColumns.includes(th.text().trim())) {
                var select = $('<select></select>')
                    ...
                    .on('change', function () {
                        ...
                        var filters = [];
                        $("#newTasksTable thead select").each(function () {
                            var filter = {
        ...
        var resetButton = $('<button></button>')
            ...
            .on('click', function () {
                ...
                $("#newTasksTable thead select").val('');

                $('#newTasksTable_filter input').val('');
            });

        var searchWrapper = $('#newTasksTable_filter');
...
<?php /**PATH /home/c/cx34222/task_manager/public_html/tasks/resources/views/user/pages/newTasks.blade.php ENDPATH**/ ?>