    ...
    <div id="page-heading">
        ...
        <div class="row mt-12">
            <div id="controls" class="col-md-12">
                ...
                <input type="checkbox" data-column-class="col-6" >
                <label for=""> Тип </label>
                <input type="checkbox" data-column-class="col-7" >
                ...
                <div class="table-responsive">
                    <table id="example" class="table table-hover">
                        ...
                        <tr>
                            ...
                            <th data-td="td_four" class="col-2" style="width: 10%">Описание<span class="btn btn-right">></span></th>
                            ...
                            <th class="text-center col-10">Дата создания</th>
...
<?php $__env->startSection('script'); ?>
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            const checkboxes = document.querySelectorAll('input[type="checkbox"][data-column-class]');

            // Установка начального состояния видимости столбцов
            checkboxes.forEach(checkbox => {
                toggleColumn(checkbox.dataset.columnClass, checkbox.checked);
            });

            // Обработчик событий для изменения видимости столбцов
            const controls = document.getElementById('controls');
            controls.addEventListener('change', e => {
                if (e.target.dataset.columnClass) {
                    toggleColumn(e.target.dataset.columnClass, e.target.checked);
                }
            });
        });
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tasks\resources\views/admin/monitoring/index.blade.php ENDPATH**/ ?>