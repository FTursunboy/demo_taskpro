                        ...
                        <table id="example" class="table table-hover">
                            ...
                            <?php $__empty_1 = true; $__currentLoopData = $tasks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $task): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    ...
                                    <td><?php echo e(\Str::limit($task->name,50)); ?></td>
                                    ...
                                    <?php endif; ?>
                                    <td>
                                        <a class="badge bg-success p-2" href="<?php echo e(route('offers.show', $task->slug)); ?>"><i
                                                class="bi bi-eye"></i></a>
                                        <a data-bs-toggle="offcanvas" data-bs-target="#EditTaskClient<?php echo e($task->id); ?>"
                                           aria-controls="EditTaskClient<?php echo e($task->id); ?>" class=" badge bg-primary p-2" href="<?php echo e(route('offers.edit', $task->id)); ?>"><i
                                ...
                                <div class="offcanvas offcanvas-bottom" data-bs-backdrop="static" tabindex="-1" id="EditTaskClient<?php echo e($task->id); ?>"
                                     aria-labelledby="EditTaskClient<?php echo e($task->id); ?>" style="width: 100%; height: 80%;">
                                    <div class="offcanvas-header">
                                        <h5 class="offcanvas-title" id="EditTaskClient<?php echo e($task->id); ?>"><?php echo e($task->name); ?></h5>
                                    ...
                                    <div class="offcanvas-body">
                                        <div class="container my-5">
                                            <div class="row d-flex justify-content-center">
                                                <div class="col-lg-9">
                                                    <form method="post" action="<?php echo e(route('offers.update', $task->id)); ?>"
                                                        ...
                                                        <div class="row g-3">
                                                            <div class="col-md-6">
                                                                ...
                                                                <textarea id="name" class="form-control"
                                                                          name="name"
                                                                          rows="5" required><?php echo e($task->name); ?></textarea>
                                                            </div>
                                                            <div class="col-md-6">
                                                                ...
                                                                <input type="text"
                                                                       ...
                                                                       value="<?php echo e($task->author_name); ?>" required>
                                                            </div>
                                                            <div class="col-md-6">
                                                                ...
                                                                <input type="text"
                                                                       ...
                                                                       value="<?php echo e($task->author_phone); ?>" required>
                                                            </div>
                                                            <div class="col-md-6">
                                                            ...
                                                            <div class="col-12">
                                                                ...
                                                                <textarea id="description" class="form-control"
                                                                          name="description"
                                                                          rows="5"><?php echo e($task->description); ?></textarea>
                                                            </div>
                                                            <div class="col-md-6">
...
<?php echo $__env->make('client.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/c/cx34222/task_manager/public_html/tasks/resources/views/client/offers/index.blade.php ENDPATH**/ ?>