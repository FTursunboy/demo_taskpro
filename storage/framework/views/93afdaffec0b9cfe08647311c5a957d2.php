...
<?php $__env->startSection('content'); ?>
    ...
    <div id="page-heading">
        ...
        <section class="section">
            <div class="row">
                <div class="col-6 col-lg-3  col-md-">
                    <div class="card">
                        <div class="card-body px-4 py-4-5">
                            <a href="<?php echo e(route('all-tasks.index')); ?>">
                                <div class="row">
                                    <div
                               ...
                               aria-controls="ProjectOfCanvas">
                                <div class="row">
                                    ...
                                    <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                                        ...
                                        <h6 class="font-extrabold mb-0"><?php echo e($new_tasks); ?></h6>
                                    </div>
                                </div>
                            </a>
                        </div>
                               ...
                               aria-controls="verAdmin">
                                <div class="row">
                                    ...
                                    <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                                        ...
                                        <h6 class="font-extrabold mb-0"><?php echo e($ver_admin); ?></h6>
                                    </div>
                                </div>
                            </a>
                        </div>
                               ...
                               aria-controls="verClient">
                                <div class="row">
                                    ...
                                    <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                                        ...
                                        <h6 class="font-extrabold mb-0"><?php echo e($tasks_count); ?></h6>
                                    </div>
                                </div>
                            </a>
                        </div>
                            ...
                            aria-controls="reject">
                                <div class="row">
                                    ...
                                    <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                                        ...
                                        <h6 class="font-extrabold mb-0"><?php echo e($rejectClientCount); ?></h6>
                                    </div>
                                </div>
                            </a>
                        </div>
                ...
                <div>
                    <input type="hidden" value="<?php echo e($task['inProgress']); ?>" id="taskProgressId">
                    <input type="hidden" value="<?php echo e($task['speed']); ?>" id="taskSpeedId">
                    <input type="hidden" value="<?php echo e($ver_admin); ?>" id="taskVerAdminId">
                    <input type="hidden" value="<?php echo e($tasks_count); ?>" id="taskVerClientId">
                    <input type="hidden" value="<?php echo e($rejectClientCount); ?>" id="taskRejectId">
                    <input type="hidden" value="<?php echo e($task['success']); ?>" id="tasksuccessId">
                </div>
    ...
    <?php echo $__env->make('user.pages.newTasks', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php echo $__env->make('user.pages.tasksInProgress', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php echo $__env->make('user.pages.speed', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php echo $__env->make('user.pages.verAdmin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php echo $__env->make('user.pages.verClient', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php echo $__env->make('user.pages.reject', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php echo $__env->make('user.pages.archive', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php echo $__env->make('user.vendor_scripts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<script src="<?php echo e(asset('assets/js/apexcharts.init.js')); ?>"></script>
...
<?php echo $__env->make('user.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/c/cx34222/task_manager/public_html/tasks/resources/views/user/index.blade.php ENDPATH**/ ?>