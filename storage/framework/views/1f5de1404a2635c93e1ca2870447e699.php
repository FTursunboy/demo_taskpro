<div class="offcanvas offcanvas-bottom" data-bs-backdrop="static" tabindex="-1" id="archive"
     aria-labelledby="archive" style="width: 100%; height: 100%;">
    <div class="offcanvas-header">
        <h5 class="offcanvas-title" id="ProjectOfCanvas">Архивированные задачи</h5>
    ...
    <div class="offcanvas-body">
        <div class="card">
            <div class="card-body overflow-hidden">
                <div>
                    <table id="archiveTable" class="table table-hover mt-3 " cellpadding="5">
                        <thead>
                        <tr>
                        ...
                        <tbody>
                        <?php $__currentLoopData = $tasksInArchive; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $task): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
    ...
    $(document).ready(function () {
        ...
        var resetButton = $('<button></button>')
            ...
            .on('click', function () {
                ...
                $('#archiveTable_filter input').val('');
            });

        var searchWrapper = $('#archiveTable_filter');
...
<?php /**PATH /home/c/cx34222/task_manager/public_html/tasks/resources/views/user/pages/archive.blade.php ENDPATH**/ ?>