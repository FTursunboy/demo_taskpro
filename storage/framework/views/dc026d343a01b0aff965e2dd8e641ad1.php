    ...
    <div class="offcanvas-body">
        <div class="card">
            <div class="card-body overflow-hidden">
                <div>
                    <table id="speedTable" class="table table-hover mt-3 " cellpadding="5">
                        <thead>
                        <tr>
                        ...
                        <tbody>
                        <?php $__currentLoopData = $tasksSpeed; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $task): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
...
<script>
    $(document).ready(function () {
        var table = $('#speedTable').DataTable({
            "processing": true,
            "stateSave": true
        });
        ...
        $("#speedTable thead th").each(function(i) {
            ...
            if (filterColumns.includes(th.text().trim())) {
                var select = $('<select></select>')
                    ...
                    .on('change', function () {
                        ...
                        var filters = [];
                        $("#speedTable thead select").each(function () {
                            var filter = {
        ...
        var resetButton = $('<button></button>')
            ...
            .on('click', function () {
                ...
                $("#speedTable thead select").val('');

                $('#speedTable_filter input').val('');
            });

        var searchWrapper = $('#speedTable_filter');
...
<?php /**PATH /home/c/cx34222/task_manager/public_html/tasks/resources/views/user/pages/speed.blade.php ENDPATH**/ ?>