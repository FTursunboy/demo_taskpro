            ...
            <div class="card-body overflow-hidden">
                <div>
                    <table class="table table-hover mt-3 " cellpadding="5">
                        ...
                        <tbody>
                        <?php $__currentLoopData = $projectTasksOfDashboardUser->unique('project_id'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $task): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="">
                                <td><?php echo e($loop->index+1); ?></td>
                                <td><?php echo e($task?->project?->name); ?></td>
                                <td class="text-center"><?php echo e($task?->project?->count_task_user()); ?></td>
                                <td class="text-center"><?php echo e($task?->project?->count_ready_user()); ?></td>
                                <td class="text-center"><?php echo e($task?->project?->count_process_user()); ?></td>
                                <td class="text-center"><?php echo e($task?->project?->count_verificateClient_user()); ?></td>
                                <td class="text-center"><?php echo e($task?->project?->count_verificateAdmin_user()); ?></td>
                                <td class="text-center"><?php echo e($task?->project?->count_outOfDate_user()); ?></td>
                                <td class="text-center"><?php echo e($task?->project?->count_other_user()); ?></td>
                            </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </tbody>
                    </table>
...
<?php /**PATH /home/c/cx34222/task_manager/public_html/tasks/resources/views/user/incs/header.blade.php ENDPATH**/ ?>