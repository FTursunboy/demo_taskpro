<div class="offcanvas offcanvas-bottom" data-bs-backdrop="static" tabindex="-1" id="verClient"
     aria-labelledby="verClient" style="width: 100%; height: 100%;">
            ...
            <div class="card-body overflow-hidden">
                <div>
                    <table id="verClientTable" class="table table-hover mt-3 " cellpadding="5">
                        ...
                        <tbody>
                        <?php $__currentLoopData = $tasksVerClient; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $task): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
...
<?php /**PATH /home/c/cx34222/task_manager/public_html/tasks/resources/views/user/pages/verClient.blade.php ENDPATH**/ ?>