...
<div id="auth">
    ...
    <div class="row h-100">
        <div class="col-lg-5 col-12">
            <div id="auth-left">
                <div class="auth-logo">
                    <a href="#"><img src="<?php echo e(asset('assets/images/logo/logo2.svg')); ?>" alt="Logo"></a>
                </div>
                <h1 class="auth-title">Забыли пароль</h1>
                <p class="auth-subtitle mb-5">Для восстановление пароля введите логин </p>
                <?php if(\Session::has('error')): ?>
                    <div class="alert alert-danger">
                        <p class="text-center"><?php echo e(\Session::get('error')); ?></p>
                    </div>
                <?php endif; ?>
                <form action="<?php echo e(route('forgot.update')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <div class="form-group position-relative has-icon-left mb-4">
                        <input type="text" class="form-control form-control-xl" placeholder="Логин" required name="login"   value="<?php echo e(old('login')); ?>">
                ...
                <div class="text-center mt-5 text-lg fs-4">
                    <p class='text-gray-600'><a href="<?php echo e(route('login')); ?>" class="font-bold">Вход</a>.
                    </p>
                </div>
            </div>
        </div>
...
<?php /**PATH /home/c/cx34222/task_manager/public_html/tasks/resources/views/auth/forgot.blade.php ENDPATH**/ ?>