...
Route::group(['middleware' => 'auth:sanctum'], function () {
    Route::group(['as' => 'tasks'], function (){
        ...
        Route::get('/tasks/create', [\App\Http\Controllers\API\V1\Tasks\TaskController::class, 'create']);
        Route::post('/tasks/store', [\App\Http\Controllers\API\V1\Tasks\TaskController::class, 'store']);
