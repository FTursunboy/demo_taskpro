...
!function (n) {
    ...
    function Yt(t, e, n) {
        var a = t._iDisplayStart, r = t._iDisplayLength, o = t.fnRecordsDisplay(),
            o = (0 === o || -1 === r ? a = 0 : "number" == typeof e ? o < (a = e * r) && (a = 0) : "first" == e ? a = 0 : "назад" == e ? (a = 0 <= r ? a - r : 0) < 0 && (a = 0) : "вперед" == e ? a + r < o && (a += r) : "last" == e ? a = Math.floor((o - 1) / r) * r : W(t, 0, "Unknown paging action: " + e, 5), t._iDisplayStart !== a);
    ...
    function Qt(n) {
        ...
        var e, a, r, o, i, l = n.oScroll, s = l.sX, u = l.sXInner, c = l.sY, l = l.iBarWidth, f = P(n.nScrollHead),
            ...
            x = T.bScrollOversize, A = (H(n.aoColumns, "nTh"), []), I = [], F = [], L = [],
    ...
    var Ie = [], o = Array.prototype, B = function (t, e) {
        ...
        oLanguage: {
            ...
            oPaginate: {sFirst: "Первый", sLast: "Последний",},
            sEmptyTable: "Нет данных в таблице",
            sInfo: "Показ от _START_ до _END_ из _TOTAL_ данных",
            sInfoEmpty: "Нет данных для показа",
            sInfoFiltered: "(Фильтровано из _MAX_  данных)",
            sInfoPostFix: "",
            sDecimal: "",
            sThousands: ",",
            sLengthMenu: "Показ _MENU_ данных на каждой странице",
