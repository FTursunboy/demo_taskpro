...
class TelegramTeamLeadSendTaskInUser extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function __construct($id, $name, $time, $from, $to, $deadline, $type, $teamLead)
    {
        $this->taskID = $id;
        $this->taskName = $name;
        $this->taskTime = $time;
    ...
    public function toTelegram($notifiable)
    {
        return TelegramMessage::create()
            ->content("Здравствуйте, Вам поступила новая задача.
                ...
                \n Тип : {$this->tasktype}
                \n Вам ваш тимлид {$this->teamLead} поставила вам новая задача и админ приял ее.
                ");
    }
}
