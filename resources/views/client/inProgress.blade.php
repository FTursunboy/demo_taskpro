            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6 order-md-2 order-first">
                    <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item active" aria-current="page"><a href="{{ route('client.index') }}">Панель</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Задачи в процессе</li>
                        </ol>
                    </nav>
                </div>
            </div>
                                        ...
                                        <div class="tab-pane fade {{( $loop->index === 0) ? 'active show' : '' }}"
                                            ...
                                            <div class="row">
                                                <div class="col-4">
                                                    ...
                                                    @else
                                                        <a href="{{ route('offers.show', $task->id) }}"
                                        ...
                                        <div class="modal fade" id="delete{{$task->id}}" data-bs-backdrop="static"
                                            ...
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    <form action="{{ route('offers.delete', $task->id) }}" method="POST">
                                                        @csrf
                                                        @method('DELETE')
