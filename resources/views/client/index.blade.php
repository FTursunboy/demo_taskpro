                            ...
                            <a href="{{ route('show_ready') }}">
                                <div class="row">
                                    ...
                                    <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                                        ...
                                        <h6 class="font-extrabold mb-0">{{ $task['verificate'] }}</h6>
                                    </div>
                                </div>
                            </a>
                        </div>
                        ...
                        <div class="card-body px-4 py-4-5">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                                    ...
                                    <h6 class="font-extrabold mb-0">{{ $in_progress}}</h6>
                                </div>
                            </div>
                            </a>
                        </div>
                            ...
                            <a href="{{ route('expected_admin') }}">
                                <div class="row">
                                    ...
                                    <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                                        ...
                                        <h6 class="font-extrabold mb-0">{{ $admin_verification }}</h6>
                                    </div>
                                </div>
                            </a>
                        </div>
                            ...
                            <a href="{{ route('verificate_admin') }}">
                                <div class="row">
                                    ...
                                    <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                                        ...
                                        <h6 class="font-extrabold mb-0">{{ $verificate_admin }}</h6>
                                    </div>
                                </div>
                            </a>
                        </div>
                            ...
                            <a href="{{ route('expected_user') }}">
                                <div class="row">
                                    ...
                                    <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                                        ...
                                        <h6 class="font-extrabold mb-0">{{ $cancel_admin }}</h6>
                                    </div>
                                </div>
                            </a>
                        </div>
                            ...
                            <a href="{{ route('reject_client') }}">
                                <div class="row">
                                    ...
                                    <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                                        ...
                                        <h6 class="font-extrabold mb-0">{{ $client_reject }}</h6>
                                    </div>
                                </div>
                            </a>
                        </div>
