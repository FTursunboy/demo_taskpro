                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea disabled name="description" class="form-control" rows="3"
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <div class="form-group">
                                                        <label>Бюджет</label>
                                                        <textarea disabled name="budget" class="form-control" rows="4"
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    <div class="input-group date" id="reservationdate"
                                                        ...
                                                        <input disabled name="from" value="{{$idea->from}}" placeholder="Введите срок" type="date"
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    <div class="input-group date" id="reservationdated"
                                                         data-target-input="nearest">
                                                        <input disabled value="{{$idea->to}}" name="to" placeholder="Введите срок" type="date"
                                                               class="form-control datetimepicker-input"
