                        ...
                        <div class="row">
                            ...
                            <div class="col-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" id="password" name="password" class="form-control mt-3" value="">
                                </div>
                            ...
                            <div class="col-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="position" name="position" class="form-control mt-3" value="{{ $user->position }}" required>
                                </div>

                                <div class="form-group">
                                    <label for="telegram_id">Телеграм ID<span class="text-danger">*</span></label>
                                    <input type="number" id="telegram_id" name="telegram_id" class="form-control mt-3" value="{{ $user->telegram_user_id }}" required>
                                </div>
                            </div>
