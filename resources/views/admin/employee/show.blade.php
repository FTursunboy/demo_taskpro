...
@section('content')
    ...
    <div id="page-heading">
        ...
        @if($user->getRoleNames()->contains('team-lead'))
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <a href="{{ route('employee.deleteCommand', $user->id) }}" class="btn btn-danger">Да</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            {{--     add any group role teamlead start       --}}
            ...
            {{--     add any group role teamlead end       --}}
                ...
                <div class="col-9">
                    @if($user->getRoleNames()->contains('team-lead'))
                        ...
                        <table class="table table-hover bg-white rounded-4 mt-3">
                            ...
                            <tbody>
                            @foreach($userCommand->commandProjects($user->id) as $use)
                                <tr class="text-center">
                                    <td>{{ $loop->iteration }}</td>
                                    <td>{{ $use->name }}</td>
                                    <td>
                                        <a href="{{ route('employee.command-show', [$user->id,$use->project_id]) }}" class="badge bg-success"><i class="bi bi-eye mr-2"></i></a>
                                ...
                                <div class="modal fade" id="deleteFromCommand" data-bs-backdrop="static"
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <form
                                                    action="{{ route('employee.delete-from-command', [$use->project_id,$user->id]) }}"
                                                    method="POST">
                                                @csrf
                                                <div class="modal-body">
